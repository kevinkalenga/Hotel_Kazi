...
<body>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          <h2 style="color: green; font-size: 26px;"><strong>Easy Hotel</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               EasyHotel Head Office
               Email: support@easyhotel.com <br>
               Mob: 1245454545 <br>
               France 75001, Paris:#4 <br>
            </pre>
        </td>
    </tr>
  </table>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 5 0 5px;" class="font">
    ...
    <tbody>
        <tr>
            ...
            <!-- Total = prix × nombre de chambres × nombre de nuits -->
