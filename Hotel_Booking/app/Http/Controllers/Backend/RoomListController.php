...
class RoomListController extends Controller
{
    public function ViewRoomList()
    {
        ...
        ->leftJoin('booking_room_lists.room_number_id', 'room_numbers.id')
        ->leftJoin('bookings', 'bookings_id', 'booking_room_lists.booking_id')
        ->select(
            'room_numbers.*',
        ...
        )->orderBy('room_types.id', 'asc')->orderBy('bookings.id', 'desc')->get();
