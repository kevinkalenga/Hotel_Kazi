        ...
        <div class="row pt-45">
            ...
            @foreach($rooms as $item)
                ...
                @php
                    ...
                    // Valeur par défaut si le formulaire n’est pas soumis
                    $persion = old('persion', 1);
                @endphp

                @if($av_room > 0 && $persion <= $item->total_adult)
                    ...
                    <div class="room-card">
                        ...
                        <div class="content">
                            ...
                            <p class="text-success mb-1">
                                Chambres disponibles : {{ $item->available_rooms }}
                            </p>
