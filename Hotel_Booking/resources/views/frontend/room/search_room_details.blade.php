        ...
        <div class="room-details-area pt-100 pb-70">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Room Details Slider & Content -->
                    <div class="col-lg-8">
                        <div class="room-details-article">
                            <div class="room-details-slider owl-carousel owl-theme">
                                @foreach($multiImages as $image)
                                    <div class="room-details-item">
                                        <img src="{{asset('upload/rooming/multi_img/'.$image->multi_img)}}" alt="Images">
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="services-bar-widget">
                                        ...
                                        <div class="side-bar-list">
                                            <ul>
                                                <li><a href="#"> <b>Capacity : </b> {{$roomDetails->room_capacity}} Person <i class='bx bxs-cloud-download'></i></a></li>
                                                <li><a href="#"> <b>Size : </b> {{$roomDetails->size}} <i class='bx bxs-cloud-download'></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="services-bar-widget">
                                        ...
                                        <div class="side-bar-list">
                                            <ul>
                                                <li><a href="#"> <b>View : </b> {{$roomDetails->view}} <i class='bx bxs-cloud-download'></i></a></li>
                                                <li><a href="#"> <b>Bed Style : </b> {{$roomDetails->bed_style}} <i class='bx bxs-cloud-download'></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="room-details-review">
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                                <textarea name="message" class="form-control" cols="30" rows="8" required placeholder="Write your review here...."></textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-7 col-md-8 p-0">
                                    <div class="room-card-content">
                                        ...
                                        <a href="{{url('room/details/'.$item->id)}}" class="book-more-btn">Book Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
