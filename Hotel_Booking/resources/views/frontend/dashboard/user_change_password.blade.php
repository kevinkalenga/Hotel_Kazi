                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="old_password" class="form-control @error('old_password')
                                             is-invalid @enderror" id="old_password" />
                                    ...
                                    <div class="col-lg-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="new_password" class="form-control @error('new_password')
                                             is-invalid @enderror" id="new_password" />
                                    ...
                                    <div class="col-lg-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="new_password_confirmation" class="form-control @error('new_password_confirmation')
                                             is-invalid @enderror" id="new_password_confirmation" />
