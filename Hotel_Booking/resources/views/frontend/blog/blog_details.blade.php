                            ...
                            <div class="comments-wrap">
								...
								<ul>
                                  @foreach($comment as $com)
									<li>
										<img src="{{(!empty($com->user->photo)) ? url('upload/user_images/'.$com->user->photo) :
                                         url('upload/default_avatar.jpg')}}" alt="Image" style="width:50px; height:50px;">
										<h3>{{$com->user->name}}</h3>
                            ...
                            <div class="comments-form">
                                <div class="contact-form">
                                    ...
                                    @endphp
                                     ...
                                     @else 
                                        <p>Please <a href="{{route('login')}}">Login</a> first in order to add a comment</p>
