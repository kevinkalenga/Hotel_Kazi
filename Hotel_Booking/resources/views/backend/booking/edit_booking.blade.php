                  ...
                  <form action="">
                      <div class="row ">
                         <div class="col-md-12 mb-2">
                            ...
                            <input type="date" name="check_in" class="form-control" required value="{{$editData->check_in}}">
                         </div>
                         <div class="col-md-12 mb-2">
                            <label for="">CheckOut</label>
                            <input type="date" name="check_out" class="form-control" required value="{{$editData->check_out}}">
                         </div>
                         <div class="col-md-12 mb-2">
