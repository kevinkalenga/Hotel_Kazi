                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <form class="row g-3" method="POST" action="{{ route('store.blog.post') }}" enctype="multipart/form-data">
                                ...
                                <!-- Long Description -->
                                <div class="col-md-12">
                                    <label for="myeditorinstance" class="form-label">Post Description</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="showImage" src="{{ url('upload/default_avatar.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
                                </div>
